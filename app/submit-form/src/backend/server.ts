...
fastify.get("/signin", async (request, reply) => {
  console.log("---------- /signin request =>", request.params);
...
fastify.post("/account/signin", async (request, reply) => {
  console.log("---------- /account/signin request =>", request.body);
...
fastify.get("/signup", async (request, reply) => {
  console.log("---------- /signup request =>", request.params);
  const serverMsg = readFlashCookie(request);
...
fastify.post("/account/signup", async (request, reply) => {
  console.log("---------- /account/signup request =>", request.body);
